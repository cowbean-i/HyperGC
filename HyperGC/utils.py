...
def drop_hyperedges(hyperedge_index: Tensor, num_nodes: int, num_edges: int, p: float,max_len,seed_select):
    ...
    edge_size=torch.tensor(edge_size,dtype=torch.int64).to(device)
